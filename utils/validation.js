export const patterns = {
    fullName: /^[A-ZÀ-Ý][a-zà-ỹ]*(?:\s[A-ZÀ-Ý][a-zà-ỹ]*)+$/,
...
export const validateField = (name, value, form) => {
    ...
    switch (name) {
        case 'fullName':
            ...
            else if (!patterns.fullName.test(value)) error = 'Họ và tên phải có ít nhất hai từ, mỗi từ bắt đầu bằng chữ hoa (ví dụ: Nguyen Anh Huy hoặc Nguyen Toàn)';
            break;
        case 'userName':
        ...
        case 'passWord':
            ...
            else if (!patterns.passWord.test(value)) error = 'Mật khẩu phải có ít nhất 8 ký tự, bao gồm chữ hoa, chữ thường, số và ký tự đặc biệt';
            break;
